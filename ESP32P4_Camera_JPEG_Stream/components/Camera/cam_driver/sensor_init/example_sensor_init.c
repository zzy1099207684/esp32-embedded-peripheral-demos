...
esp_err_t example_sensor_init(example_sensor_config_t *sensor_config, example_sensor_handle_t *out_sensor_handle)
{
    ...
    ret = esp_cam_sensor_set_format(cam, cam_cur_fmt);
    if (ret != ESP_OK) {
